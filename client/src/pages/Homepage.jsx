          ...
          <div className="w-1/5 py-5 px-5 bg-gray-100 space-y-4">
            ...
            <div>
              <button
                ...
                className="rounded-md w-full bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600"
              >
                Reset filter
              </button>
            </div>
